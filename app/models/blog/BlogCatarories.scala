...
object BlogCatarories extends ModelCompanion[BlogCatarories, ObjectId] {
  val dao = new SalatDAO[BlogCatarories, ObjectId](collection = mongoCollection("blogCatarory")) {}
